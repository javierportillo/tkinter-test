...
def Resta():                                          
   ...
   n2=float(caja2.get())
   resta=n1-n2                                      
   tkMessageBox.showinfo("Mensaje","El resultado es: %.2f"%resta)                     
   caja1.delete(0,20)
   caja2.delete(0,20)
...
def Multiplicacion():                          
   ...
   tkMessageBox.showinfo("Mensaje","El resultado es: %.2f"%multiplicacion)     
   caja1.delete(0,20)
   caja2.delete(0,20)
#Metodo para calcular la divisi0n
def Division():                                      
   n1=float(caja1.get())                       
   n2=float(caja2.get())
   division=n1/n2                 
   tkMessageBox.showinfo("Mensaje","El resultado es: %.2f"%division)                 
   caja1.delete(0,20)
   caja2.delete(0,20)
